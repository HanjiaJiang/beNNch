...
def make_panels_benchmark_model(
    ...
    events_neuro_b, save_path="makefig_benchmark_model", fig_width=6):
    ...
    fig, axe = plt.subplots(1, 1, figsize=(fig_width, 1.5))
    axe.set_position(pos)
    ...
    plot_hist(axe_d, events_sr_b, n_neurons_hist_b, ylims=ylims_hist_high, xlims=xlims)
    if True:
        axe_top_d = fig_d.add_axes(axe_d.get_position())
        plot_hist(axe_top_d, events_sr_b, n_neurons_hist_b, xlims=xlims)
