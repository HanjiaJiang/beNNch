...
model = "fixtotal_block" # "sparse" or "synchronous"
...
network_params = {
    ...
    "pool_type": "block",  # astrocyte pool will be chosen randomly for each target neuron
...
syn_params = {
    ...
    "d_i": 2.0 if model == "synchronous" else 1.0,  # delay of inhibitory connection in ms
}
...
tau_syn_ex = 2.0
tau_syn_in = 2.0 if model == "synchronous" else 4.0
...
def plot_conn_distr(nodes_ex, nodes_astro, n_hist=None):
    for conn_name, source_nodes, target_nodes in zip(["n2n", "n2a", "a2n"], [nodes_ex, nodes_ex, nodes_astro], [nodes_ex, nodes_astro, nodes_ex]):
        ...
        plots.plot_conn_hist(
            ...
            ylabel="Number of cases", title="Fixed-total-number")
