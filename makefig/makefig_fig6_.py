...
h_major, h = 4, 1.75
left, top, bottom = 1.5, 0.8, 0.8
shift_y_major = 0.2
panels_dict = {
    "plot_major_weak":        {"width": 8, "height": h_major, "position": (1, bottom+h*4+top+shift_y_major)},
    "legend_major_weak":      {"width": 2, "height": h_major, "position": (9, bottom+h*4+top+shift_y_major)},
...
figure_size_inch = (12, bottom+4*h+h_major+2*top)
...
label_names = [
    [
        {"A": (label_shift_x, bottom+h*4+4+top+label_shift_y)},
        {"B": (label_shift_x, bottom+h*4+label_shift_y)},
    ],
]
label_text_1 = [
    [
        {"Weak scaling": (0.8, bottom+h*4+h_major+top+label_shift_y)},
        {"Astrocyte-to-neuron connectivity (at scale = 4)": (0.8, bottom+h*4+label_shift_y)},
    ],
]
text_shift_x = 1.6
text_shift_y = 0.9
