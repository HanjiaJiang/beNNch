...
composite_figure_name_root = 'fig3'
...
label_names = [
    [
        {"A": (xshift, 0.5+1.5+3+1.5+3+space*3+yshift)},
        {"B": (xshift, 0.5+1.5+3+1.5+space*2+yshift)},
        {"C": (xshift, 0.5+1.5+3+space+yshift)},
        {"D": (xshift, 0.5+1.5+yshift)},
    ],
]
label_text = [
    [
        {"Sparse":      (3,   figure_size_inch[1]-0.15)},
        {"Synchronous": (6+3, figure_size_inch[1]-0.15)},
        {"Raster plot": (5.8, 0.5+1.5+3+1.5+3+space*3+yshift)},
        {"Neuronal firing rate": (5.8, 0.5+1.5+3+1.5+space*2+yshift)},
        {"Astrocytic dynamics": (5.8, 0.5+1.5+3+space+yshift)},
        {"Astrocytic SIC input per neuron": (5.8, 0.5+1.5+yshift)},
        {"Time (ms)":    (3,   0.2)},
        {"Time (ms)":    (6+3, 0.2)},
    ],
]
...
def some_matplotlib_figure(
    ...
    function_a(label_names, size=25, bold=True, ha="left", va="center")
...
def create_composite_figure(name_root,master_file_name,panels_dict,draw_grid=False,fig_size=(10,10),folder_name="."):
