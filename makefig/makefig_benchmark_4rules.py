...
panels_dict = {
    "plot_major_4rules_strong":    {"width": 3,  "height": 8, "position": (0, 0)},
    "plot_major_4rules_weak":      {"width": 3,  "height": 8, "position": (3.5, 0)},
    "legend_major_4rules":         {"width": 3,  "height": 8, "position": (7, 0)},
}
final_panel_shrink = 1.0
figure_size_inch = (10, 8+0.5)
