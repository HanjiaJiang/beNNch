...
shift_y_major = 0.0
panels_dict = {
    "plot_major_weak":        {"width": 8, "height": h_major, "position":    (0, h_major+top_b+shift_y_major)},
    "legend_major_weak":      {"width": 2, "height": h_major, "position":    (8, h_major+top_b+shift_y_major)},

    "plot_phases_weak":        {"width": 8, "height": h_major, "position":   (0, shift_y_major)},
    "legend_phases_weak":      {"width": 2, "height": h_major, "position":   (8, shift_y_major)},
}
final_panel_shrink = 1.0
figure_size_inch = (10, 2*h_major+top_b)

########## SET PANEL LABELS ##########
label_shift_x = 0.1
label_text_3 = [
    [
        {"Phases of state propagation": (4.2, h_major+0.15)},
    ],
]
...
def some_matplotlib_figure(
    ...
    function_a(label_text_3, size=22, bold=False, ha="center", va="center")
