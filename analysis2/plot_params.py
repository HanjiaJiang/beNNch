...
label_params = {
    ...
    'time_update': 'Update',
    'time_collocate_spike_data': 'Spike Collocation',
    'time_communicate_spike_data': 'Spike Communication',
    'time_deliver_spike_data': 'Spike Delivery',
    'time_construct': 'Network construction',
    'max_memory': 'Memory',
    'sim_factor': 'State propagation',
    'time_update_frac': 'Update',
    'time_communicate_spike_data_frac': 'Spike Communication',
    'time_deliver_spike_data_frac': 'Spike Delivery',
    'time_collocate_spike_data_frac': 'Spike Collocation',
    'secondary_gd_frac': 'Secondary GD',
    'time_deliver_secondary_data_frac': 'Spike Delivery',
    'time_gather_secondary_data_frac': 'Secondary Gathering',
    'time_update_factor': 'Update',
    'time_communicate_spike_data_factor': 'Spike Communication',
    'time_deliver_spike_data_factor': 'Spike Delivery',
    'time_collocate_spike_data_factor': 'Spike Collocation',
    'secondary_gd_factor': 'Secondary GD',
    'time_deliver_secondary_data_factor': 'Secondary Delivery',
    'time_gather_secondary_data_factor': 'Secondary Gathering',
